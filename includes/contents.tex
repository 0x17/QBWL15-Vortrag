...
\begin{frame}[t]
	...
	\begin{center}
		...
		\only<1>{
			...
			\textcolor{white}{$\mbox{DB} = 20\mbox{ GE} - 20\mbox{ GE} = 0\mbox{ GE}$}
		}
		...
		\only<3>{
			Früheste Reihenfolgezulässigkeit $\underline{t}$\\
			$\mbox{DB} = 20\mbox{ GE} - 20\mbox{ GE} = 0\mbox{ GE}$
		}
		...
		\only<5>{
			Inkrementiere\\
			$\mbox{DB} = 15\mbox{ GE} - 10\mbox{ GE} = 5\mbox{ GE}$
		}
		
		\only<6>{
			Früheste Ressourcenzulässigkeit $\overline{t}$\\
			$\mbox{DB} = 0\mbox{ GE} - 0\mbox{ GE} = 0\mbox{ GE}$
		}
